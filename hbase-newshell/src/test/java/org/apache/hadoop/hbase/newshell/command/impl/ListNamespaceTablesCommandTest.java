...
@Tag(SmallTests.TAG)
public class ListNamespaceTablesCommandTest {
  ...
  private final ListNamespaceTablesCommand command = new ListNamespaceTablesCommand();
  private final RecordingShellAdmin admin = new RecordingShellAdmin();
  private final ExecutionContext context =
    new ExecutionContext(admin, new StubShellTableFactory(), new PrintWriter(new StringWriter()));

  @Test
  public void reportsTablesInNamespace() throws Exception {
    var parsed = ShellLineParser.parse("list_namespace_tables 'ns1'");
