...
public class AlterNamespaceCommandTest {
  ...
  private final AlterNamespaceCommand command = new AlterNamespaceCommand();
  ...
  public void setsProperty() throws Exception {
    ...
    assertEquals("set", admin.lastProperties.get("METHOD"));
    assertEquals("VAL", admin.lastProperties.get("PROP"));
  }
