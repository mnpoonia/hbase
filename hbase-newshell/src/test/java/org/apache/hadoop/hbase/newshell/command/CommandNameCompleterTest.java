...
@Tag(SmallTests.TAG)
public class CommandNameCompleterTest {
  ...
  @Test
  public void doesNotCompletePastFirstToken() {
    CommandNameCompleter completer = completerFor("create", "count");
    assertTrue(completer.complete("create 'mytab", 13).isEmpty());
  }

  @Test
  public void returnsNoCandidatesWhenPrefixMatchesNothing() {
    CommandNameCompleter completer = completerFor("status");
    assertTrue(completer.complete("zzz", 3).isEmpty());
  }
}
