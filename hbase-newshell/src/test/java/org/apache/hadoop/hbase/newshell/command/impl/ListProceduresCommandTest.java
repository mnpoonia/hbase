...
@Tag(SmallTests.TAG)
public class ListProceduresCommandTest {
  ...
  private final ListProceduresCommand command = new ListProceduresCommand();
  private final RecordingShellAdmin admin = new RecordingShellAdmin();
  private final ExecutionContext context =
    new ExecutionContext(admin, new StubShellTableFactory(), new PrintWriter(new StringWriter()));

  @Test
  public void listsProcedures() throws Exception {
    var parsed = ShellLineParser.parse("list_procedures");
