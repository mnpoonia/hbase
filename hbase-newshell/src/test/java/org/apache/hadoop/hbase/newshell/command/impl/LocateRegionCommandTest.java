...
@Tag(SmallTests.TAG)
public class LocateRegionCommandTest {
  ...
  private final LocateRegionCommand command = new LocateRegionCommand();
  private final RecordingShellAdmin admin = new RecordingShellAdmin();
  private final ExecutionContext context =
    new ExecutionContext(admin, new StubShellTableFactory(), new PrintWriter(new StringWriter()));

  @Test
  public void reportsHostAndRegion() throws Exception {
    var parsed = ShellLineParser.parse("locate_region 't1', 'row0'");
