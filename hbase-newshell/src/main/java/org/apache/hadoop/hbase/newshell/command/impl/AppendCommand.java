...
/**
 * Ported from hbase-shell's {@code hbase/table.rb#_append_internal}: a single
 * {@code family:qualifier} column, appending the given value and printing the resulting cell.
 */
@InterfaceAudience.Private
public final class AppendCommand implements ShellCommand {
  @Override
  public String name() {
    return "append";
  }
  ...
  @Override
  public String help() {
    return "append 'table', 'row', 'family:qualifier', 'value' - append to a cell's value";
  }
  ...
  public CommandResult execute(ParsedCommand command, ExecutionContext context)
    ...
    return TextResult.of("CURRENT VALUE = " + current);
  }
}
