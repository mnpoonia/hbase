...
/**
 * Ported from hbase-shell's {@code shell/commands/delete_snapshot.rb}: a single snapshot name.
 */
@InterfaceAudience.Private
public final class DeleteSnapshotCommand implements ShellCommand {
  @Override
  public String name() {
  ...
  @Override
  public String help() {
    return "delete_snapshot 'snapshotName' - delete a snapshot";
  }
