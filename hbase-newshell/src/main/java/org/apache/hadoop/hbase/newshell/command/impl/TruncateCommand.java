...
/**
 * Ported from hbase-shell's {@code shell/commands/truncate.rb}: {@code Admin.truncateTable} with
 * {@code preserveSplits=false}.
 */
...
public final class TruncateCommand implements ShellCommand {
  ...
  @Override
  public String help() {
    return "truncate 'table' - disable, drop and recreate a table";
  }
