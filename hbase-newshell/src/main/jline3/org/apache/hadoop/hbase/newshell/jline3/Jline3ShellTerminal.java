...
/**
 * {@link ShellTerminal} backed by JLine 3.x's {@code Terminal}/{@code LineReader}. Only this
 * class (and {@link Jline3TerminalProvider}) may reference {@code org.jline} types - newshell's
 * core never does.
 */
@InterfaceAudience.Private
final class Jline3ShellTerminal implements ShellTerminal, SupportsHistory {
  ...
  Jline3ShellTerminal(TerminalConfig config) throws IOException {
