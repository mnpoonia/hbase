...
/**
 * {@link TerminalProvider} backed by JLine 4.x, intended for JDK11+ HBase branches. On this
 * module's own build, whichever backend module is compiled in via the JDK-activated
...
public final class Jline4TerminalProvider implements TerminalProvider {
  static final String NAME = "jline4";
  ...
  public ShellTerminal open(TerminalConfig config) throws IOException {
    return new Jline4ShellTerminal(config);
  }
}
